...
export const RegisterPage = () => {
  ...
  const { name, lastname, email, password, repeatedpass } = formValues;
  ...
  //TODO añadir navbar, footer en return
  return (
      ...
      <form onSubmit={onSubmit} className={styles.form}>
        <div className={styles.fistInputBlock}>
          <div className={styles.form_control}>
            ...
            <input
              ...
              value={name}
            />
            {showErrorName && <small className={styles.error}>Error Name</small>}
          </div>
          ...
          <div className={styles.form_control}>
            ...
            <input
              ...
              onChange={onChange}
              onBlur={()=> onBlurHandler(validateLastName, setShowErrorLastname)}
              value={lastname}
            />
            {showErrorLastname && <small className={styles.error}>Error Last Name</small>}
          </div>
        </div>
        ...
        <div className={styles.form_control}>
          ...
          <input
            ...
            autoComplete="on"
          />
          {showErrorEmail && <small className={styles.error}>Error Email</small>}
        </div>
        ...
        <div className={styles.form_control}>
          ...
          />
          {showErrorPassword && <small className={styles.error}>Error Password</small>}
        </div>
        ...
        <div className={styles.form_control}>
          ...
          <input
            ...
            onChange={onChange}
            onBlur={()=> onBlurHandler(validateRepeatedpass, setShowErrorRepeatedpass)}
            value={repeatedpass}
            autoComplete="current-password"
          />
          {showErrorRepeatedpass && <small className={styles.error}>Error Confirm password</small>}
        </div>
